    ...
    <div class="card mt-4">
        <div class="cards-head">
            <div class="d-flex justify-content-between">
                ...
                <a
                    class="btn btn-add text-white btn-info"
                    data-toggle="modal"
                    data-target="#exampleModal"
                    id="add_new"
                    ><i class="fas fa-eye"></i> Add Customer</a
                >
            </div>
        </div>
        <div class="card-body">
...
export default {
    ...
    methods: {
        ...
        AddToCart(id) {
            axios
                .get("http://127.0.0.1:8000/api/addTocart/" + id)
                .then(() => {});
        },
        AllCart() {
            axios
        ...
        removeItem(id) {
            axios
                .get("http://127.0.0.1:8000/api/removeCart/" + id)
                .then(() => {});
        },
        increment(id) {
